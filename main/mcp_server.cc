...
#include "boards/common/local_alarm.h"
...
void McpServer::AddCommonTools() {
    ...
    // Initialize and register local hardware alarm clock tools
    LocalAlarmClock::GetInstance().Initialize();
    LocalAlarmClock::GetInstance().RegisterMcpTools();
